...
import { RepairFormData, RepairCategory, RepairPriority } from "@/types";
...
export function RequestForm({ onSubmit, onClose }: RequestFormProps) {
  ...
  const onFormSubmit = (data: RepairFormData) => {
    onSubmit({
      ...data,
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => setValue("category", value as RepairCategory)}
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => setValue("priority", value as RepairPriority)}
            >
              <SelectTrigger>
