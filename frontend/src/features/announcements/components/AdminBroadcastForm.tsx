...
interface AdminBroadcastFormProps {
  onBroadcast: (data: AnnouncementFormData) => void;
}
    ...
    return (
      ...
      >
        ...
        <div className="text-left flex-1">
          <h4 className="text-primary font-semibold">Admin Broadcast</h4>
    ...
    <Card>
      <CardContent className="p-5">
        <div className="flex items-center gap-2 mb-4">
          <Megaphone className="w-5 h-5 text-primary" />
          <h3 className="text-primary font-semibold">Admin Broadcast</h3>
        </div>
